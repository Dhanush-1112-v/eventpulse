...
document.getElementById("confirmRSVP").addEventListener("click", () => {
    ...
    window.open("booking.html", "_blank"); // Open ticket booking page in a new tab
    document.getElementById("rsvpModal").style.display = "none";
});
function showPopup() {
    ...
    // Hide the popup after 1 minute (60000ms)
    setTimeout(() => {
        popup.style.display = "none";
    }, 60000);
}

// Show a random popup 5 seconds after page loads
